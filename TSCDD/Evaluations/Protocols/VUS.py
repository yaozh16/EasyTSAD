...
from TSCDD.Evaluations import MetricInterface
from .. import MetricInterface, EvalInterface
from ..Metrics import SingleValueMetric, SingleValueMetric
...
class VUS_ROC(EvalInterface):
    ...
    def calc(self, scores, labels, margins) -> MetricInterface:
        ...
        *_, VUS_ROC, VUS_PR = generate_curve(labels, scores, 2 * slidingWindow)
        ...
        return SingleValueMetric(value=VUS_ROC, name=self.name)


class VUS_PR(EvalInterface):
    def __init__(self) -> None:
        super().__init__()
        self.name = "vus pr"
    ...
    def calc(self, scores, labels, margins) -> MetricInterface:
        ...
        *_, VUS_ROC, VUS_PR = generate_curve(labels, scores, 2 * slidingWindow)
        ...
        return SingleValueMetric(value=VUS_PR, name=self.name)


class R_AUC(EvalInterface):
    def __init__(self) -> None:
        super().__init__()
    ...
    def calc(self, scores, labels, margins) -> MetricInterface:
        ...
        return SingleValueMetric(value=R_AUC, name=self.name)


class R_AP(EvalInterface):
    def __init__(self) -> None:
        super().__init__()
    ...
    def calc(self, scores, labels, margins) -> MetricInterface:
        ...
        return SingleValueMetric(value=R_AP, name=self.name)
