...
class BVARNIG(ProbabilityModel):
    ...
    def __init__(self,
        ...
        if prior_mean_beta is not None:
    ...
    def evaluate_log_prior_predictive(self, y, t):
        ...
        return min(0.0, BVARNIG.mvt_log_density(resid, (self.a / self.b) * self.C_t_inv_r0, log_det, 2 * self.a, True))
    ...
    def update_predictive_distributions(self, y_t, y_tm1, x_exo_t, x_exo_tp1, t,
        ...
        self.XX_old, self.XY_old, self.X_t_old = (self.XX.copy(), self.XY.copy(), self.X_t.copy())
        self.Y_new, self.Y_old = y_t, y_tm1

        """STEP 2.2: Updates X'X, X'Y, Y'Y, XX_rt, XY_rt, YY_rt"""
        self.regressor_cross_product_updates(y_t, y_tm1, x_exo_t, t, padding_column_tm1)
    ...
    def mvt_log_density(y_flat, prec, log_det, df, prior=False, alerts=False):
        ...
        log_term = (1 + (1.0 / nu) * np.matmul(np.matmul(y_flat, prec), y_flat.T))
